...
var varienGridMassactionSpProductrelater = Class.create(varienGridMassaction);

varienGridMassactionSpProductrelater.prototype.initialize = function (containerId, grid, checkedValues, formFieldNameInternal, formFieldName) 
{
    // MAGE -- begin
...
// Multiselect 
varienGridMassactionSpProductrelater.prototype.onMultiSelect = function(events) 
{
...
varienGridMassactionSpProductrelater.prototype.apply = function() 
{
...
varienGridMassactionSpProductrelater.prototype.walkSelectedRows = function(walkFunction, warningLimit) 
{
